...
-- Дамп данных таблицы puzzle.events: ~0 rows (приблизительно)
DELETE FROM `events`;
...
INSERT INTO `events` (`id`, `title`, `author`, `datetime`, `body`, `image`, `image_attr_title`, `image_attr_alt`, `created_ip`, `created_datetime`, `created_user`, `created_username`, `modified_ip`, `modified_datetime`, `modified_user`, `modified_username`, `active`) VALUES
	...
	(3, 'Лекция по гироскопии: «Прецизионный ротор: основные моменты»', 'Шульженко Клавдия', '2015-04-14 16:09:59', NULL, NULL, NULL, NULL, '127.0.0.1', '2015-04-12 16:09:59', 1, 'zzeraw', '127.0.0.1', '2015-04-12 16:09:59', 1, 'zzeraw', 1),
	...
	(6, 'Лекция по почвоведению: «Почему когерентна гумусированность?»', 'Лещенко Лев', '2015-04-17 16:09:59', NULL, NULL, NULL, NULL, '127.0.0.1', '2015-04-12 16:09:59', 1, 'zzeraw', '127.0.0.1', '2015-04-12 16:09:59', 1, 'zzeraw', 1);
...
-- Дамп данных таблицы puzzle.reviews: ~0 rows (приблизительно)
DELETE FROM `reviews`;
