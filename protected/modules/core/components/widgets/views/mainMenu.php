...
<ul class="nav navbar-nav">
    ...
    <li class="<?=(Yii::app()->request->url == Yii::app()->createUrl('pages/default/view', array('alias' => 'proizvodstvo'))) ? 'active' : ''?>">
        <a href="<?=Yii::app()->createUrl('pages/default/view', array('alias' => 'proizvodstvo'))?>">
            Производство
        </a>
    </li>
    <li class="<?=(Yii::app()->request->url == Yii::app()->createUrl('pages/default/view', array('alias' => 'shipping'))) ? 'active' : ''?>">
        <a href="<?=Yii::app()->createUrl('pages/default/view', array('alias' => 'shipping'))?>">
            Отгрузки
        </a>
    </li>
